...
/**
 * Provides the local service interface for Goods. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GoodsLocalServiceUtil
...
public interface GoodsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GoodsLocalServiceUtil} to access the goods local service. Add custom service methods to {@link com.test.csvimport.service.impl.GoodsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Goods createGoods(long id);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Goods deleteGoods(long id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Goods fetchGoods(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Goods getGoods(long id) throws PortalException;
