...
import com.test.csvimport.model.GoodsModel;
import com.test.csvimport.model.GoodsSoap;
...
public class GoodsModelImpl extends BaseModelImpl<Goods> implements GoodsModel {
	...
	public static final String TABLE_SQL_CREATE = "create table TEST_Goods (uuid_ VARCHAR(75) null,id_ LONG not null primary key,name VARCHAR(512) null,description TEXT null,length DOUBLE,height DOUBLE,area DOUBLE,nr TEXT null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.test.csvimport.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.test.csvimport.model.Goods"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.test.csvimport.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.test.csvimport.model.Goods"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.test.csvimport.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.test.csvimport.model.Goods"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.test.csvimport.service.util.ServiceProps.get(
				"lock.expiration.time.com.test.csvimport.model.Goods"));
	...
	public String toXmlString() {
		...
		sb.append("com.test.csvimport.model.Goods");
